...
const Template1 = ({
  ...
  // Hàm hiển thị ngày từ chuẩn DB ra chuẩn UI
  ...
  return (
    <div className="a4-paper template-1">
        ...
        <div className="t1-left-body">
          <div className="t1-contact-list">
            <div className="t1-contact-item">
              ...
              {/* TRỞ VỀ DẠNG TEXT ĐƠN GIẢN NHẤT */}
              <span
                contentEditable
                suppressContentEditableWarning
          ...
          <div className="t1-left-section">
            ...
            <div className="t1-left-item">
              ...
              <span
                ...
                suppressContentEditableWarning
                placeholder="0"
                /* Khóa gõ chữ và khóa gõ quá 2 số */
                onKeyPress={(e) => {
      ...
      {/* ... (Phần Cột phải giữ nguyên không đổi) ... */}
      <div className="t1-right-pane">
        ...
        <div className="t1-right-body">
          <div className="t1-right-section">
            ...
            <p
              className="t1-right-text"
              contentEditable
              suppressContentEditableWarning
              placeholder="Nhập tóm tắt mục tiêu nghề nghiệp của bạn tại đây..."
            ...
            {displayExperiences.map((exp, index) => (
              <div key={`exp-${index}`} style={{ marginBottom: "15px" }}>
                <strong
                  ...
                  style={{ display: "block", fontSize: "15px", color: "#333" }}
                >
                  {exp.companyName}
                </strong>
                <i
                  contentEditable
                  suppressContentEditableWarning
                  placeholder="Vị trí đảm nhiệm (VD: Backend Developer)"
                  onBlur={(e) =>
                    handleArrayChange(
                      "experiences",
                      index,
            ...
            {displayEducations.map((edu, index) => (
              <div key={`edu-${index}`} style={{ marginBottom: "15px" }}>
                ...
                <p
                  ...
                  contentEditable
                  suppressContentEditableWarning
                  placeholder="- Xếp loại, điểm GPA hoặc đồ án..."
                  onBlur={(e) =>
                    handleArrayChange(
                      "educations",
                      index,
