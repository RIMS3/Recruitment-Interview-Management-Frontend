...
const JobManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Number(formData.experience) < 0) {
            return toast.warning("Kinh nghiệm không được là số âm!");
        }
                        ...
                        currentJobs.map(job => (
                            <div key={job.id} className="jm-card">
                                ...
                                <div className="jm-tags">
                                    ...
                                    <span className="jm-tag jm-tag-experience">
                                        <Award size={11} />
                                        {job.experience === 0 ? 'Không yêu cầu KN' : `${job.experience} năm kinh nghiệm`}
                                    </span>
                                </div>
                    ...
                    <form onSubmit={handleSubmit} className="jm-modal">
                        ...
                        <div className="jm-modal-body">
                            ...
                            <div>
                                ...
                                <div className="jm-form-group">
                                    <label className="jm-label">Kinh nghiệm yêu cầu (năm)</label>
                                    <input
                                        type="number"
                                        min="0"
                                        className="jm-input"
